...
/*stone change:  只需要启动usb口时钟  */
  ...
  //stone:add//////////////////////////////////////////////////////////////////////////////////////////////////////////
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE);          //时能端口复用时钟
  GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable , ENABLE);     //禁止jtag接口
//stone:add//////////////////////////////////////////////////////////////////////////////////////////////////////////	
#endif
